...
// @ts-nocheck 
/*
 * This file exports the `OrderEventOutbox` model and its related types.
 *
...
export type GetOrderEventOutboxAggregateType<T extends OrderEventOutboxAggregateArgs> = {
      [P in keyof T & keyof AggregateOrderEventOutbox]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateOrderEventOutbox[P]>
    : Prisma.GetScalarType<T[P], AggregateOrderEventOutbox[P]>
}
...
export type GetOrderEventOutboxGroupByPayload<T extends OrderEventOutboxGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<OrderEventOutboxGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof OrderEventOutboxGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], OrderEventOutboxGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], OrderEventOutboxGroupByOutputType[P]>
      }
    >
  >
...
export type OrderEventOutboxCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<OrderEventOutboxFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface OrderEventOutboxDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['OrderEventOutbox'], meta: { name: 'OrderEventOutbox' } }
  /**
   ...
   * })
  **/
  count<T extends OrderEventOutboxCountArgs>(
    args?: Prisma.Subset<T, OrderEventOutboxCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], OrderEventOutboxCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends OrderEventOutboxGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, OrderEventOutboxGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetOrderEventOutboxGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
