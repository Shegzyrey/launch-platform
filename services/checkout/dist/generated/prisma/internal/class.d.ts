 ...
 * `prisma.order`: Exposes CRUD operations for the **Order** model.
  ...
  */
    ...
    /**
     * `prisma.orderEventOutbox`: Exposes CRUD operations for the **OrderEventOutbox** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more OrderEventOutboxes
      * const orderEventOutboxes = await prisma.orderEventOutbox.findMany()
      * ```
      */
    get orderEventOutbox(): Prisma.OrderEventOutboxDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
